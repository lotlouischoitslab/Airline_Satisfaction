...
![title](images/a350.png)

- ##### Image source: [Airbus Products and Services](https://www.airbus.com/en/products-services/commercial-aircraft/passenger-aircraft/a350-family)
...
![title](images/kal787.png)

- ##### Image source: [Korean Air to restore long haul networks](https://www.koreanair.com/us/en/footer/about-us/newsroom/list/220609--korean-air-to-restore-long-haul-network-destinations-in-)

#### Incheon International Airport Terminal 2 (인천국제공항 제2여객터미널) is shown below.
![title](images/incheon.png)
...
![title](images/age.png)
#### Figure 1. above shows the ages of airline passengers.

![title](images/flight_distance.png)
...
![title](images/cleaned_dataset.png)
...
![title](images/kmeans_training.png)
...
![title](images/optimal_kmeans.png)
...
![title](images/incheon_robots.png)
